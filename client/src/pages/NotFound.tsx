  ...
  return (
    <div className="min-h-screen bg-[#050818] text-white flex items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center max-w-lg">
        <img src={`${BASE}logo-skull-imposing.png`} alt="" className="w-32 h-32 mx-auto mb-8 object-contain opacity-50" style={{ filter: 'drop-shadow(0 0 30px rgba(255,0,255,0.3))' }} />
        ...
        <p className="text-gray-500 text-sm mb-8 font-mono">Cette page n'existe pas dans le Vide Stellaire.</p>
