...
const ASSETS = {
  ...
  logoFull: `${BASE}logo-skull-imposing.png`,
};
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/">
            <div className="flex items-center gap-3 cursor-pointer">
              <img src={ASSETS.logo} alt="FF" className="w-12 h-12 object-contain" style={{ filter: 'drop-shadow(0 0 12px rgba(0,240,255,0.6))' }} />
          ...
          <div className="flex items-center gap-3">
            <Link href="/shop"><button className="hidden sm:block px-3 py-2 rounded-lg text-xs font-bold cursor-pointer transition-all hover:scale-105" style={{ background: 'rgba(255,0,255,0.1)', border: '1px solid rgba(255,0,255,0.3)', color: '#ff00ff' }}>BOUTIQUE</button></Link>
            <Link href="/leaderboard"><button className="hidden sm:block px-3 py-2 rounded-lg text-xs font-bold cursor-pointer transition-all hover:scale-105" style={{ background: 'rgba(0,255,136,0.1)', border: '1px solid rgba(0,255,136,0.3)', color: '#00ff88' }}>CLASSEMENT</button></Link>
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex justify-center mb-8 relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-cyan-500/20 blur-[80px] animate-pulse" />
              <img 
                src={ASSETS.logo} 
                alt="Fail Frenzy" 
                className="w-48 h-48 sm:w-56 sm:h-56 relative z-10 object-contain" 
                style={{ 
